...
public interface CommentOAS {
    ...
    @ApiResponse(
            ...
            headers =
                    @Header(
                            ...
                            description = "댓글 조회 URI",
                            required = true))
    @Operation(summary = "Write my comment by post id", description = "댓글을 작성합니다.")
    ...
    @ApiResponse(responseCode = "200", description = "댓글 페이지 조회 성공")
    @PageParameters
            ...
            content =
                    @Content(
                            schema =
                                    @Schema(
                                            implementation =
                                                    CommentInformationProjectionDto.class)))
    @Operation(summary = "Find comment by comment id", description = "댓글을 조회합니다.")
    ...
    @NotFoundCommentResponse
    @SecurityResponse
    @ApiResponse(responseCode = "204", description = "자신의 댓글 수정 성공")
    @Operation(summary = "Edit my comment by comment id", description = "자신의 댓글을 수정합니다.")
    void edit(
            UserPrincipal principal,
    ...
    @NotFoundCommentResponse
    @SecurityResponse
    @ApiResponse(responseCode = "204", description = "자신의 댓글 삭제 성공")
    @Operation(summary = "Delete my comment by comment id", description = "자신의 댓글을 삭제합니다.")
    void delete(UserPrincipal principal, @Schema(description = "댓글 식별자") Long commentId);
}
